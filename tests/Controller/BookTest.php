...
class BookTest extends ControllerBaseCase {
    ...
    public function testAdminEdit() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Pages")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Price")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Description")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated Published")')->count());
    }
    ...
    public function testAdminNew() : void {
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Pages")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Price")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Description")')->count());
        $this->assertSame(1, $responseCrawler->filter('td:contains("New Published")')->count());
    }
