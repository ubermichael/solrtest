...
class FirmTest extends ControllerBaseCase {
    // Change this to HTTP_OK when the site is public.
    private const ANON_RESPONSE_CODE = Response::HTTP_FOUND;

    private const TYPEAHEAD_QUERY = 'firm';
    ...
    public function testAnonTypeahead() : void {
        $this->client->request('GET', '/firm/typeahead?q=' . self::TYPEAHEAD_QUERY);
    ...
    public function testAnonSearch() : void {
        ...
        $repo->method('searchQuery')->willReturn([$this->getReference('firm.1')]);
        $this->client->disableReboot();
        $this->client->getContainer()->set('test.' . FirmRepository::class, $repo);

        $crawler = $this->client->request('GET', '/firm/search');
        $this->assertSame(self::ANON_RESPONSE_CODE, $this->client->getResponse()->getStatusCode());
        if (self::ANON_RESPONSE_CODE === Response::HTTP_FOUND) {
            // If authentication is required stop here.
            return;
    ...
    public function testAdminEdit() : void {
        ...
        $form = $formCrawler->selectButton('Save')->form([
            'firm[name]' => 'Updated Name',
            'firm[streetAddress]' => 'Updated StreetAddress',
            'firm[startDate]' => 'Updated StartDate',
            'firm[endDate]' => 'Updated EndDate',
        ]);
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("Updated StreetAddress")')->count());
    ...
    public function testAnonNewPopup() : void {
        $crawler = $this->client->request('GET', '/firm/new_popup');
        $this->assertSame(Response::HTTP_FOUND, $this->client->getResponse()->getStatusCode());
        $this->assertTrue($this->client->getResponse()->isRedirect());
    }
    ...
    public function testAdminNew() : void {
        ...
        $form = $formCrawler->selectButton('Save')->form([
            'firm[name]' => 'New Name',
            'firm[streetAddress]' => 'New StreetAddress',
            'firm[startDate]' => 'New StartDate',
            'firm[endDate]' => 'New EndDate',
        ]);
        ...
        $this->assertSame(1, $responseCrawler->filter('td:contains("New StreetAddress")')->count());
    ...
    public function testAdminNewPopup() : void {
        $this->login('user.admin');
        $formCrawler = $this->client->request('GET', '/firm/new_popup');
        $this->assertSame(Response::HTTP_OK, $this->client->getResponse()->getStatusCode());
    ...
    public function testAdminDelete() : void {
        $repo = self::$container->get(FirmRepository::class);
